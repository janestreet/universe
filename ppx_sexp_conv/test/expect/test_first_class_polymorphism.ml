  ...
  let (_the_group : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.group) =
    {
      ...
      origin =
        "ppx_sexp_conv/test/expect/test_first_class_polymorphism.ml.Variable_never_used"
    } in
  let (t_sexp_grammar : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.t) =
    Ref ("t", _the_group) in
  t_sexp_grammar
  ...
  let (_the_group : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.group) =
    {
      ...
      generic_group = _the_generic_group;
      origin =
        "ppx_sexp_conv/test/expect/test_first_class_polymorphism.ml.Variable_used"
    } in
  let (t_sexp_grammar : Ppx_sexp_conv_lib.Sexp.Private.Raw_grammar.t) =
    Ref ("t", _the_group) in
  t_sexp_grammar
